...
var _user$project$Main$update = F2(
	function (msg, model) {
		return _user$project$Main$Model;
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$content = A2(
	_debois$elm_mdl$Material_Card$view,
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$NoOp),
				_1: {ctor: '[]'}
			}
		}
	},
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Click anywhere'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
		_1: {
			...
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(' clicks so far.')),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('(not here)'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$view = function (model) {
	return A3(_debois$elm_mdl$Material_Scheme$topWithScheme, _debois$elm_mdl$Material_Color$Teal, _debois$elm_mdl$Material_Color$Red, _user$project$Main$content);
};
